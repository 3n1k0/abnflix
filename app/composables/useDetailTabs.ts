...
export function useDetailTabs(props: { castCount?: MaybeRef<number | null>; episodeCount?: MaybeRef<number | null> }) {
  ...
  const tabs = computed(() => [
    ...
    { key: 'episodes' as DetailTabKey, label: 'Episodes', count: unref(props.episodeCount) ?? null },
  ])
